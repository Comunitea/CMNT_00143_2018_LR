...
class L10nEsVatBookLineTaxPrev(models.Model):
    _name = 'l10n.es.vat.book.line.tax.prev'

    vat_book_line_id = fields.Many2one(comodel_name='l10n.es.vat.book.line.prev',
