...
class L10nEsVatBookLinePrev(models.Model):
    _name = 'l10n.es.vat.book.line.prev'
    ...
    vat_book_id = fields.Many2one(
        comodel_name='l10n.es.vat.book.prev',
        string='Vat Book id')
    ...
    tax_line_ids = fields.One2many(comodel_name='l10n.es.vat.book.line.tax.prev',
