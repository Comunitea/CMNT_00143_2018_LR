...
class L10nEsVatBookPrev(models.Model):
    _name = 'l10n.es.vat.book.prev'
    ...
    line_ids = fields.One2many(
        comodel_name='l10n.es.vat.book.line.prev',
    ...
    tax_summary_ids = fields.One2many(
        comodel_name='l10n.es.vat.book.tax.summary.prev',
        string="Tax Summary",
        inverse_name='vat_book_id',
        readonly="True")
    ...
    summary_ids = fields.One2many(
        comodel_name='l10n.es.vat.book.summary.prev',
        string="Summary",
        inverse_name='vat_book_id',
        readonly="True")
    ...
    def _create_vat_book_tax_summary(self, tax_summary_data_recs,
        ...
        for tax_id in tax_summary_data_recs.keys():
            self.env['l10n.es.vat.book.tax.summary.prev'].create(
    ...
    def _create_vat_book_summary(self, tax_summary_recs, book_type):
        ...
        self.env['l10n.es.vat.book.summary.prev'].create(vals)
    ...
    def _create_vat_book_line_tax(self, tax, vat_book_line_id,
                                  move):
        vat_book_line_tax_obj = self.env['l10n.es.vat.book.line.tax.prev']
    ...
    def _create_vat_book_line(self, move, line_type):
        ...
        """
        vat_book_line_obj = self.env['l10n.es.vat.book.line.prev']
    ...
    def _calculate_vat_book(self):
        ...
        for rec in self:
            ...
            if rec.auto_renumber:
                rec_invs = self.env['l10n.es.vat.book.line.prev'].search(
                    [('vat_book_id', '=', rec.id),
                     ('line_type', '=', 'received')],
