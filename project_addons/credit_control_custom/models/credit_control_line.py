...
class CreditControlLine(models.Model):
    ...
    def create_or_update_from_mv_lines(self, lines, level, controlling_date,
        ...
        new_lines = super(CreditControlLine, self).create_or_update_from_mv_lines(lines, level, controlling_date, check_tolerance=True)
            ...
            if unpaid_lines:
                for line in unpaid_lines:
                    ...
                    if check_tolerance and open_amount < cur_tolerance:
                        continue
                    vals = self._prepare_from_move_line(line, level, controlling_date, open_amount)
