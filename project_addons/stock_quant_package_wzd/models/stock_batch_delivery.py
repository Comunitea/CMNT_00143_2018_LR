...
class StockBatchDelivery(models.Model):
    ...
    def action_confirm(self):
        ...
        for delivery_id in self:
            ...
            moves_to_split = picking_ids.mapped('move_line_ids').filtered(lambda x: not x.result_package_id or x.result_package_id.batch_delivery_id != delivery_id).mapped('move_id')
