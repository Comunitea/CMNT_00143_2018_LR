...
class SaleOrder(models.Model):
    ...
    financiable_payment = fields.Boolean(
        "Financiable", help="Default financiable for partner orders"
    )
    phone_order = fields.Boolean()
    cash_payment = fields.Boolean(
        "Pago contado", help="Default payment for partner orders"
    )
